    namespace A6 {
        ...
        for (let i:number=0; i<3;i++) {
            ...
            let s: Skierdata = new Skierdata(skiX, skiY, skiDX, skiDY, skiColorb, skiColors);
            objects.push(s);
        }
        ...
        for (let i:number=0; i<3;i++) {
            ...
            let s: Clouddata = new Clouddata(cloudX, cloudY);
            objects.push(s);
        ...
        //snow
         for (let i: number = 0; i <300; i++) {
            ...
            let s: Snowdata = new Snowdata(snowX, snowY);
            objects.push(s);
        }
